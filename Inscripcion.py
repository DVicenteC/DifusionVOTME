...
try:
    ...
    try:
        ...
        if not cursos_disponibles.empty:
            ...
            # Región de residencia del participante (la comuna y dirección se derivan del CT)
            st.write("**Datos de ubicación:**")
            st.caption("La región corresponde a la residencia del participante. La comuna y dirección se completan automáticamente desde el centro de trabajo.")
            ...
            with st.form("registro_form"):
                ...
                # Datos de empresa derivados del centro de trabajo seleccionado
